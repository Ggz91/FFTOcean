...
public class UICommonData
{
   ...
   static public string IFFTOceanHeightPNGPath = @"Assets/BakedTextures/IFFTOceanHeightPNG.png";
   ...
   static public string IFFTOceanLutBytesPath = @"Assets/BakedTextures/LutTex.bytes";
